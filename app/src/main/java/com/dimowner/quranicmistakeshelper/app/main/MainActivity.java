...
import com.dimowner.quranicmistakeshelper.ARApplication;
import com.dimowner.quranicmistakeshelper.ColorMap;
import com.dimowner.quranicmistakeshelper.IntArrayList;
import com.dimowner.quranicmistakeshelper.R;
import com.dimowner.quranicmistakeshelper.app.DecodeService;
import com.dimowner.quranicmistakeshelper.app.DecodeServiceListener;
import com.dimowner.quranicmistakeshelper.app.DownloadService;
import com.dimowner.quranicmistakeshelper.app.PlaybackService;
import com.dimowner.quranicmistakeshelper.app.RecordingService;
import com.dimowner.quranicmistakeshelper.app.info.ActivityInformation;
import com.dimowner.quranicmistakeshelper.app.info.RecordInfo;
import com.dimowner.quranicmistakeshelper.app.records.RecordsActivity;
import com.dimowner.quranicmistakeshelper.app.settings.SettingsActivity;
import com.dimowner.quranicmistakeshelper.app.welcome.WelcomeActivity;
import com.dimowner.quranicmistakeshelper.app.widget.RecordingWaveformView;
import com.dimowner.quranicmistakeshelper.app.widget.WaveformViewNew;
import com.dimowner.quranicmistakeshelper.data.database.Record;
import com.dimowner.quranicmistakeshelper.util.AndroidUtils;
import com.dimowner.quranicmistakeshelper.util.AnimationUtil;
import com.dimowner.quranicmistakeshelper.util.FileUtil;
import com.dimowner.quranicmistakeshelper.util.TimeUtils;
...
//		txtName.setVisibility(View.INVISIBLE);
	...
	public void asyncUploadTast(File s){

		progressBar.setVisibility(View.VISIBLE);
		String url = "https://arabicspeechapisfinal.herokuapp.com/speechrecognition";

		Log.i("myUploadTaskruning","function");
		...
		RequestBody body = new MultipartBody.Builder().setType(MultipartBody.FORM)
				.addFormDataPart("file", String.valueOf(s),
						RequestBody.create(MediaType.parse("application/octet-stream"),
								new File(String.valueOf(s))))
				.build();
		...
		try {
			...
			Log.i("respomnn",response.toString());
			if (response.code() == 200){
				String jsonData = response.body().string();
				JSONArray jsonArr = new JSONArray(jsonData);
				Log.i("respomnn", String.valueOf(jsonArr));
				Intent intent = new Intent(this,RecognizeTextActivity.class);
				intent.putExtra("FirstApiRes", String.valueOf(jsonArr));
...
//			e.printStackTrace();
	...
	private void firstApiCall(String jsonArr) {
		...
		Request request = new Request.Builder()
				...
				.url("https://arabicapisfinal.herokuapp.com/speechrecognition1")
				.method("GET", null)
				.build();
		try {
			Response response = client.newCall(request).execute();
			...
			Log.i("errSec",e.getLocalizedMessage());
			progressBar.setVisibility(View.GONE);
...
////				uploadFile(info.toString());
//			}
//		}, v -> {}, (buttonView, isChecked) -> presenter.setAskToRename(!isChecked));

//		Toast.makeText(this, "heleo", Toast.LENGTH_SHORT).show();
	}
